				...
				<div class="content">
					...
					<ul class="brand">
						<li>
							...
							<%--<h4 id="reportCountArea"><b id="reportCount"></b>건 신고 완료</h4>--%>
							<div class="col">
								<table>
									<colgroup>
										<col width="50%">
						...
						<li>
							...
							<%--<h4 id="arrestCountArea"><b id="arrestCount"></b>건 검거 완료</h4>--%>
							<div class="col">
								<table>
									<colgroup>
										<col width="50%">
			...
			<div id="s6" class="section">
					...
					<form id="reportingForm" class="edit" action="/ace/report" method="post" enctype="multipart/form-data" target="reportingIframe" onsubmit="validateReport(this, event);">
						...
						<ul class="enter">
							<div class="eventfinish2">
								<div class="end_info">
									<h3>신고 기간이 만료 되었습니다.<br> 그 동안 참여해 주셔서 감사합니다.<br> 추첨선물 당첨자 발표 : 6월 8일(목) </h3>
									<%-- TODO: Unhide the h4 below and edit the href. (2017.05.31)--%>
									<h4><a href="http://blog.naver.com/gojlsblog" style="display: none;"><img src="//image.gojls.com/gojls/img_ad/event/check_bt.png"/></a></h4>
								</div>
							</div>
							<li>
				...
				<div class="content">
					<form id="arrestingForm" class="edit" action="/ace/arrest" method="post" enctype="multipart/form-data" target="arrestingIframe" onsubmit="validateArrest(this, event);">
						...
						<ul class="enter">
							<div class="eventfinish3">
								<div class="end_info">
									<h3>검거 기간이 만료 되었습니다.<br> 그 동안 참여해 주셔서 감사합니다.<br> 추첨선물 당첨자 발표 : 6월 8일(목) </h3>
									<%-- TODO: Unhide the h4 below and edit the href. (2017.05.31)--%>
									<h4><a href="http://blog.naver.com/gojlsblog" style="display: none;"><img src="//image.gojls.com/gojls/img_ad/event/check_bt.png"/></a></h4>
								</div>
							</div>
