...
<head>
	...
	<link type="text/css" rel="stylesheet" media="all" href="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/css/event/20180817_main.css"/>
...
<body>
	<div id="wrap">
		<a href="http://www.gojls.com/academy/" target="_blank">
			<img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20180817_event/logo.png" class="logo"/>
		</a>
		<div class="toparea">
			<a href="#vote" class="btn_vote">
				<img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20180817_event/btn_vote.png"
					onmouseover="this.src='<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20180817_event/btn_vote_on.png'"
					onmouseout="this.src='<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20180817_event/btn_vote.png'">
			</a>
		</div>
		...
		<div id="klent">
			<div class="ucc_bt">
				<a href="https://blog.naver.com/gojlsblog/221294573351" target="_blank" class="ucc">
					<img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20180817_event/ucc.jpg">
				</a>
			</div>
		</div>
		<div id="vote">
			...
			<div class="info">
				<p><img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20180817_event/vote_info_text.png"></p>
				<a href="http://chess.gojls.com/ucc/msucc/main" target="_blank" class="btn_more">
					<img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20180817_event/btn_more.png"
						onmouseover="this.src='<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20180817_event/btn_more_on.png'"
						onmouseout="this.src='<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20180817_event/btn_more.png'">
				</a>
			</div>
		</div>
	</div>
