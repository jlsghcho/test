...
<head>
	...
	<link type="text/css" rel="stylesheet" media="all" href="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/css/event/20190211_main.css?6509035"/>
...
<body>
	<div id="wrap">
		<a href="http://www.gojls.com/academy/" target="_blank">
			<img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20190211_event/logo.png" class="logo"/>
		</a>
		...
		<div id="vote">
			...
			<div class="info">
				<p><img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20190211_event/vote_info_text.png"></p>
				<a href="http://chess.gojls.com/ucc/msucc/main" target="_blank" class="btn_more">
					<img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20190211_event/btn_more.png"
						onmouseover="this.src='<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20190211_event/btn_more_on.png'"
						onmouseout="this.src='<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20190211_event/btn_more.png'">
				</a>
			</div>
		</div>
	</div>
