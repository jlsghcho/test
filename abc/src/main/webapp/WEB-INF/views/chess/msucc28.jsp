...
<head>
	...
	<title> 정상어학원 </title>
	<link type="text/css" rel="stylesheet" media="all" href="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/css/event/20181122_main.css"/>
...
<body>
	<div id="wrap">
		<a href="http://www.gojls.com/academy/" target="_blank">
			<img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20181122_event/logo.png" class="logo"/>
		</a>
		<div class="toparea">
		...
		<div id="vote">
					...
					<div class="info_desk">
						...
						<c:choose>
							<c:when test="${isCookies eq 1}">
								<a href="<spring:eval expression="@globalContext['GOJLS_URL']" />/logout?&preURL=<spring:eval expression="@globalContext['SITE_URL']"/>/chess/msucc" class="btn"><img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20181122_event/btn_logout.png"></a>
							</c:when>
							<c:otherwise>
								<a href="<spring:eval expression="@globalContext['GOJLS_URL']" />/login?from=FLLI&preURL=<spring:eval expression="@globalContext['SITE_URL']"/>/chess/msucc" class="btn"><img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20181122_event/btn_login.png"></a>
							</c:otherwise>
						</c:choose>
					</div>
			...
			<div class="info">
				<p><img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20181122_event/vote_info_text.png"></p>
				<a href="http://chess.gojls.com/ucc/msucc/main" target="_blank" class="btn_more">
					<img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20181122_event/btn_more.png"
						onmouseover="this.src='<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20181122_event/btn_more_on.png'"
						onmouseout="this.src='<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL_HMS']" />/img/event/20181122_event/btn_more.png'">
				</a>
			</div>
		</div>
	</div>
