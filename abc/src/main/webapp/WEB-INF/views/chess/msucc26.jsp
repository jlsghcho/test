...
<head>
	...
	<link type="text/css" rel="stylesheet" media="all" href="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/css/event/20180607_main.css"/>
	...
	<script type="text/javascript" src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/js/mobi_event.js"></script>
...
<body>
	<div id="wrap">
		<a href="http://www.gojls.com/academy/" target="_blank">
			<img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/img/event/20180607_event/logo.png" class="logo"/>
		</a>
		<div class="toparea">
			<a href="#vote" class="btn_vote">
				<img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/img/event/20180607_event/btn_vote.png"
					onmouseover="this.src='<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/img/event/20180607_event/btn_vote_on.png'"
					onmouseout="this.src='<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/img/event/20180607_event/btn_vote.png'">
			</a>
			<a href="#klent" class="btn_klent">
				<img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/img/event/20180607_event/btn_klent.png"
					onmouseover="this.src='<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/img/event/20180607_event/btn_klent_on.png'"
					onmouseout="this.src='<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/img/event/20180607_event/btn_klent.png'">
			</a>
		</div>
		...
		<div id="klent">
			<div class="klent_bt">
				<a href="http://www.klent.co.kr/" target="_blank" class="btn_vote">
					<img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/img/event/20180607_event/klent_bt.png">
				</a>
			</div>
			<div class="ucc_bt">
				<a href="https://blog.naver.com/gojlsblog/221294573351" target="_blank" class="ucc">
					<img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/img/event/20180607_event/ucc.jpg">
				</a>
			</div>
		</div>
		<div id="vote">
			...
			<div class="info">
				<p><img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/img/event/20180607_event/vote_info_text.png"></p>
				<a href="http://chess.gojls.com/ucc/msucc/main" target="_blank" class="btn_more">
					<img src="<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/img/event/20180607_event/btn_more.png"
						onmouseover="this.src='<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/img/event/20180607_event/btn_more_on.png'"
						onmouseout="this.src='<spring:eval expression="@globalContext['IMG_ROOT_ANY_PROTOCOL']" />/img/event/20180607_event/btn_more.png'">
				</a>
			</div>
		</div>
	</div>
