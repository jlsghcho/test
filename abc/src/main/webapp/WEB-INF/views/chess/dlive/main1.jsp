...
<link type="text/css" rel="stylesheet" media="all" href="//image.gojls.com/gojls/inc/css/20170712_main.css" />
...
<script type="text/javascript" src="resources/js/dlive.js"></script>
...
<div id="content">
		...
		<div id="head_gnb">
      		<ul class="remote">
					...
					<li class="mission1">
						<!-- 현재 이벤트 업로드 숫자-->
						<h6><label id="totalCurrentEvnetUploadCount"><b>0</b></label>건</h6>
        ...
        <div class="nav_con">
             <ul class="nav">
				<a href="javascript:_flash1(1); sr_nav(1);" onFocus="blur()">
               		<img id="flash1" name="flash1"  src="//image.gojls.com/gojls/img_ad/event/170712/tab_study_flash1_over.gif" > 
               	</a>
               <a href="javascript:_flash1(2); sr_nav(5); changeEventList(0);" onFocus="blur()">
               		<img id="flash2" name="flash2" src="//image.gojls.com/gojls/img_ad/event/170712/tab_study_flash2.gif">
               </a>
             </ul> 
           </div>
	  	...
	  	<div id="flash1_1" >
			<div id="sr_wrap">
            	<div id="s2" class="section">
			   		<div class="content">
			    		<p><img src="//image.gojls.com/gojls/img_ad/event/170712/event_01_1.jpg" /></p>
                		<p>&nbsp;</p>
                		<p><img src="//image.gojls.com/gojls/img_ad/event/170712/event_01_2.jpg" /><img src="//image.gojls.com/gojls/img_ad/event/170712/event_01_3.jpg" /></p>
                		<h1 class="report_bt"><a href="javascript:_flash1(2); sr_nav(5); changeEventList(0);"  ><img src="//image.gojls.com/gojls/img_ad/event/170712/dream_gobt.png"></a></h1>
			  		</div>
		    	</div>
            	<div id="s3" class="section">
					<div class="content">
			    		<p><img src="//image.gojls.com/gojls/img_ad/event/170712/event_02.jpg" /></p>
                 	</div>
		    	</div>
         	</div>
		</div>
	   ...
	   <!-- 텝 2 -->
	    ...
	    <div id="sr_wrap">
			...
			<div id="s5" class="section">
			     ...
			     <!-- 이벤트 제목 -->
                <p><img src="//image.gojls.com/gojls/img_ad/event/170712/event_03.gif" /></p>
                <h1>영어노출의 감동의 순간 <label id="totalSelectEventUploadCount"><b>${currentUploadCount}</b></label> 건 인증 완료!</h1>
                
			    <h1 class="balloon" id="balloon" style="display:none;"><img src="//image.gojls.com/gojls/img_ad/event/170712/balloon.png" ></h1>
			        ...
			        <div id="blog">
			              <ul>
			                 <c:forEach begin="1" end="15" var="i">
				              		<li id="list-item${i}">
				              			<img src="//image.gojls.com/gojls/img_ad/event/170712/photo.gif" />
               		 ...
               		 <!-- 인증 게시판 앞 뒤 버튼-->
              		 <a id="abroad_prev" class="invisible" href="javascript:"><img src="//image.gojls.com/gojls/img_ad/event/170712/btn_pre.png" alt=""/></a> 
              		 <a id="abroad_next" class="invisible" href="javascript:"><img src="//image.gojls.com/gojls/img_ad/event/170712/btn_next.png" alt=""/></a>
			    ...
			    <div id="s6" class="section">
					...
					<div class="content">
		            <p><img src="//image.gojls.com/gojls/img_ad/event/170712/event_04.gif" /></p>
				...
				<div class="content">
			    	...
			    	<p><img src="//image.gojls.com/gojls/img_ad/event/170712/event_05.gif" /></p>
					...
					<form id="imageUploadingForm" class="banner1" action="/dlive/upload-image" method="post" enctype="multipart/form-data" target="dummy">
							...
							<table class="form">
					            ...
					            <tbody>
									<tr height="70px">
						                ...
						                <th rowspan="2"><img id="imageToUpload" src="//image.gojls.com/gojls/img_ad/event/170712/photo.gif" style="width:120px; height:120px;"></th>
									</tr>
									<tr class="attach" height="80px">
										<td>
											<div class="memo">
					                       	...
					                       	<p id="imageDescriptionState" style="font-size: 13px; color: #e82e51;">ㄴㅁㅇㄴㅁㅇㄴㅁㅇㄴㅁㅇ</p>					                       	
										</td>
									</tr>
								</tbody>
							</table>
				    	...
				    	<input class="check_bt01" type="button" value="" style="width:264px; height:66px; cursor: pointer; background: transparent url('//image.gojls.com/gojls/img_ad/event/170712/photo_bt.png');" onclick="onClickUpload();">
					...
					<p><img src="//image.gojls.com/gojls/img_ad/event/170712/event_06.gif"></p>
				</div>
				<br><br><br><br><br>
			</div>          
