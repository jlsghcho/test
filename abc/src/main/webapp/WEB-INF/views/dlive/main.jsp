...
<link type="text/css" rel="stylesheet" media="all" href="//image.gojls.com/hms/css/event/20181127_main.css" />
	...
	var max = 2;		//맥스숫자
		for (var i = 1; i <= max; i++) {
			...
			var img = document.getElementById("flash" + i);
				if (i == id) {
					obj.style.display = "";
					img.src = "//image.gojls.com/hms/img/event/20181127_event/tab_study_flash" + i + "_over.png";	//원본

				} else {
					obj.style.display = "none";
					img.src = "//image.gojls.com/hms/img/event/20181127_event/tab_study_flash" + i + ".png";	//변할꺼
...
<div id="content">
		<a href="http://www.gojls.com/academy/" target="_blank"><img src="//image.gojls.com/hms/img/event/20181127_event/logo.png" class="logo" /></a>
		<!-- 하단 이벤트 상황판-->
		<div id="head_gnb">
      		<ul class="remote">
					<li>
        ...
        <div class="nav_con">
             <ul class="nav">
				<a href="javascript:_flash1(1); sr_nav(1);" onFocus="blur()">
               		<img id="flash1" name="flash1"  src="//image.gojls.com/hms/img/event/20181127_event/tab_study_flash1_over.png" > 
               	</a>
               <a href="javascript:_flash1(2); sr_nav(5); changeEventList(0);" onFocus="blur()">
               		<img id="flash2" name="flash2" src="//image.gojls.com/hms/img/event/20181127_event/tab_study_flash2.png" >
               </a>
             </ul> 
           </div>
	  	...
	  	<div id="flash1_1" >
			<div id="sr_wrap">
            	<div id="s2" class="section">
			   		<div class="content">
			    		<p><img src="//image.gojls.com/hms/img/event/20181127_event/event_01_2.gif" /></p>
                 		<p><img src="//image.gojls.com/hms/img/event/20181127_event/event_01_3.gif" /></p>
                  		<p><img src="//image.gojls.com/hms/img/event/20181127_event/event_01_4.jpg" /></p>
			  		</div>
			  	</div>	
            	<div id="s3" class="section">
					<div class="content">
			    		<p><img src="//image.gojls.com/hms/img/event/20181127_event/event_01_5.gif" /></p>
                 	</div>
		    	</div>
         	</div>
		</div>
	   ...
	   <!-- 텝 2 -->
	    ...
	    <div id="sr_wrap">
			<div id="s5" class="section">
			     ...
			     <!-- 이벤트 제목 -->
               <p><img src="//image.gojls.com/hms/img/event/20181127_event/event_03.gif" /></p>
               ...
               <!-- 이벤트 제목 -->
			        ...
			        <div id="blog">
			              <ul>
			                 <c:forEach begin="1" end="15" var="i">
				              		<li id="list-item${i}">
				              			<img src="//image.gojls.com/hms/img/event/20181127_event/photo.gif" />
               		 ...
               		 <!-- 인증 게시판 앞 뒤 버튼-->
              		 <a id="abroad_prev" class="invisible" href="javascript:"><img src="//image.gojls.com/hms/img/event/20181127_event/btn_pre.png" alt=""/></a> 
              		 <a id="abroad_next" class="invisible" href="javascript:"><img src="//image.gojls.com/hms/img/event/20181127_event/btn_next.png" alt=""/></a>
			    ...
			    <div id="s6" class="section">
					...
					<div class="content">
		            <p><img src="//image.gojls.com/hms/img/event/20181127_event/event_04.gif" /></p>
				...
				<div class="content">
			    	<p><img src="//image.gojls.com/hms/img/event/20181127_event/event_05.gif" /></p>
			    	<!-- 사진 , 텍스트 인증  선택 -->
			    	<div class="pset">	
					...
					<form id="imageUploadingForm" class="banner1" action="/dlive/upload-image" method="post" enctype="multipart/form-data" target="dummy">
							...
							<table class="form">
					            ...
					            <tbody>
									<tr height="70px">
						                ...
						                <th rowspan="2"><img id="imageToUpload" src="//image.gojls.com/hms/img/event/20181127_event/photo.gif" style="width:120px; height:120px;"></th>
									</tr>
				    	...
				    	<span class="check_bt01"><a href="javascript:onClickUpload();"><img src="//image.gojls.com/hms/img/event/20181127_event/photo_bt.png"></a></span> 
