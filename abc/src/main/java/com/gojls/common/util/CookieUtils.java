...
public class CookieUtils {
    ...
    public static void deleteCookie(HttpServletResponse response, String name, String domainName) {
    	Cookie cookie = new Cookie(name, "");
    	if(!domainName.equals("")) cookie.setDomain(domainName);
        cookie.setPath("/");
        cookie.setMaxAge(0);
        response.addCookie(cookie);
    }
